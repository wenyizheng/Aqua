...
class Ui_Orderpage(object):
    def setupUi(self, Orderpage):
        ...
        self.formLayoutWidget.setGeometry(QtCore.QRect(60, 40, 758, 960))
...
"")
        ...
        self.formLayout_2.setLayout(8, QtWidgets.QFormLayout.LabelRole, self.gridLayout_4)
        self.label_3 = QtWidgets.QLabel(self.formLayoutWidget)
        self.label_3.setMinimumSize(QtCore.QSize(0, 30))
        self.label_3.setText("")
        self.label_3.setObjectName("label_3")
        self.formLayout_2.setWidget(11, QtWidgets.QFormLayout.LabelRole, self.label_3)
...
"color:#fff;")
        ...
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.cell1)
...
"color:#fff;")
        ...
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.cell3)
...
"color:#fff;")
        ...
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.cell2)
...
"color:#fff;")
        ...
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.cell4)
        self.formLayout_2.setLayout(9, QtWidgets.QFormLayout.LabelRole, self.formLayout)
        self.qrCode = QtWebKitWidgets.QWebView(self.formLayoutWidget)
        self.qrCode.setMinimumSize(QtCore.QSize(300, 300))
        self.qrCode.setMaximumSize(QtCore.QSize(300, 300))
        self.qrCode.setUrl(QtCore.QUrl("about:blank"))
        self.qrCode.setObjectName("qrCode")
        self.formLayout_2.setWidget(10, QtWidgets.QFormLayout.LabelRole, self.qrCode)
        self.gridLayoutWidget = QtWidgets.QWidget(Orderpage)
        self.gridLayoutWidget.setGeometry(QtCore.QRect(670, 40, 500, 701))
