<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:89:"/usr/local/http2/htdocs/fastadmin/public/../application/common/view/tpl/dispatch_jump.tpl";i:1504708324;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    <head>
    ...
    <body>
        <div class="system-message <?php echo $code == 1 ? 'success' : ($code == 0 ? 'error' : 'info');?>">
            <div class="image">
                <img src="__YOUPAI__/assets/img/<?php echo $code == 1 ? 'success' : ($code == 0 ? 'error' : 'info');?>.svg" alt="" width="150" />
            </div>
            <h1><?php echo($msg);?></h1>
            <p class="jump">
