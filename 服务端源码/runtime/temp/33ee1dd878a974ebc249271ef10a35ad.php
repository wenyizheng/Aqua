<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"/usr/local/http2/htdocs/fastadmin/public/../application/index/view/index/index.html";i:1504708324;s:88:"/usr/local/http2/htdocs/fastadmin/public/../application/index/view/layout/bootstrap.html";i:1504708324;}*/ ?>
<!DOCTYPE html>
<html lang="<?php echo $config['language']; ?>">
    <head>
        ...
        <!-- Loading Bootstrap -->
        <link href="__YOUPAI__/assets/css/frontend<?php echo \think\Config::get('app_debug')?'':'.min'; ?>.css?v=<?php echo \think\Config::get('site.version'); ?>" rel="stylesheet">
    ...
    <div class="row" id="component-list">
        <div class="col-sm-6 col-md-4">
            <div class="thumbnail">
                <a href="<?php echo url('index/user/login'); ?>"><img style="height: 200px; width: 100%; display: block;" src="__YOUPAI__/assets/img/third.jpg" data-holder-rendered="true"></a>
                <div class="caption">
                    <h3>第三方登录</h3>
        ...
        <div class="col-sm-6 col-md-4">
            <div class="thumbnail">
                <a href="<?php echo url('index/user/login'); ?>"><img style="height: 200px; width: 100%; display: block;" src="__YOUPAI__/assets/img/ucenter.jpg" data-holder-rendered="true"></a>
                <div class="caption">
                    <h3>Ucenter整合登录</h3>
        ...
        <div class="col-sm-6 col-md-4">
            <div class="thumbnail">
                <a href="<?php echo url('index/demo/qrcode'); ?>"><img style="height: 200px; width: 100%; display: block;" src="__YOUPAI__/assets/img/qrcode.jpg" data-holder-rendered="true"></a>
                <div class="caption">
                    <h3>二维码生成</h3>
        ...
        <div class="col-sm-6 col-md-4">
            <div class="thumbnail">
                <a href="<?php echo url('index/demo/bootstrap'); ?>"><img style="height: 200px; width: 100%; display: block;" src="__YOUPAI__/assets/img/bootstrap.jpg" data-holder-rendered="true"></a>
                <div class="caption">
                    <h3>Bootstrap组件</h3>
        ...
        <script src="__YOUPAI__/assets/js/require.js" data-main="__YOUPAI__/assets/js/require-frontend<?php echo \think\Config::get('app_debug')?'':'.min'; ?>.js?v=<?php echo $site['version']; ?>"></script>
    </body>
</html>