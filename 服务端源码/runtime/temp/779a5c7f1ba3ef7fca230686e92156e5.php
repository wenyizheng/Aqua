<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:93:"/usr/local/http2/htdocs/fastadmin/public/../application/admin/view/general/profile/index.html";i:1504708324;s:86:"/usr/local/http2/htdocs/fastadmin/public/../application/admin/view/layout/default.html";i:1504708324;s:83:"/usr/local/http2/htdocs/fastadmin/public/../application/admin/view/common/meta.html";i:1504708324;s:85:"/usr/local/http2/htdocs/fastadmin/public/../application/admin/view/common/script.html";i:1504708324;}*/ ?>
<!DOCTYPE html>
                ...
                <form id="update-form" role="form" data-toggle="validator" method="POST" action="<?php echo url('general.profile/update'); ?>">
                    ...
                    <div class="box-body box-profile">
                        ...
                        <div class="profile-avatar-container">
                            <img class="profile-user-img img-responsive img-circle plupload" src="__YOUPAI__<?php echo $admin['avatar']; ?>" alt="">
                            <div class="profile-avatar-text img-circle"><?php echo __('Click to edit'); ?></div>
                            <button id="plupload-avatar" class="plupload" data-input-id="c-avatar" data-after-upload="changeavatar"><i class="fa fa-upload"></i> <?php echo __('Upload'); ?></button>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="<?php echo __('Leave password blank if dont want to change'); ?>" name="row[password]" value=""/>
                        </div>
                        <div class="form-group">
