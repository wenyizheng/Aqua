<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:89:"/usr/local/http2/htdocs/fastadmin/public/../application/admin/view/area/roommsg/edit.html";i:1501764209;s:86:"/usr/local/http2/htdocs/fastadmin/public/../application/admin/view/layout/default.html";i:1498145896;s:83:"/usr/local/http2/htdocs/fastadmin/public/../application/admin/view/common/meta.html";i:1502811930;s:85:"/usr/local/http2/htdocs/fastadmin/public/../application/admin/view/common/script.html";i:1502811931;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-agent_id" data-rule="required" data-db-table="agent" class="form-control selectpage" name="row[agent_id]" type="text" value="<?php echo $row['agent_id']; ?>">
        </div>
    </div>
    <div class="form-group">
        <label for="c-room_name" class="control-label col-xs-12 col-sm-2"><?php echo __('Room_name'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-room_name" data-rule="required" class="form-control" name="row[room_name]" type="text" value="<?php echo $row['room_name']; ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-available_sex" class="form-control" name="row[available_sex]" type="number" value="<?php echo $row['available_sex']; ?>">
        </div>
    </div>
