<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:83:"/usr/local/http2/htdocs/fastadmin/public/../application/admin/view/index/index.html";i:1504708324;s:83:"/usr/local/http2/htdocs/fastadmin/public/../application/admin/view/common/meta.html";i:1504708324;s:85:"/usr/local/http2/htdocs/fastadmin/public/../application/admin/view/common/header.html";i:1504708324;s:83:"/usr/local/http2/htdocs/fastadmin/public/../application/admin/view/common/menu.html";i:1504708324;s:86:"/usr/local/http2/htdocs/fastadmin/public/../application/admin/view/common/control.html";i:1504708324;s:85:"/usr/local/http2/htdocs/fastadmin/public/../application/admin/view/common/script.html";i:1504708324;}*/ ?>
<!DOCTYPE html>
...
<a href="javascript:;" class="logo">
    <!-- 迷你模式下Logo的大小为50X50 -->
    <span class="logo-mini"><?php echo strtoupper(mb_substr($site['name'],0,4)); ?></span>
    <!-- 普通模式下Logo -->
    <span class="logo-lg"><b><?php echo mb_substr($site['name'],0,4); ?></b><?php echo mb_substr($site['name'],4); ?></span>
</a>
<!-- 顶部通栏样式 -->
    ...
    <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    <img src="__YOUPAI__<?php echo $admin['avatar']; ?>" class="user-image" alt="<?php echo $admin['nickname']; ?>">
                    <span class="hidden-xs"><?php echo $admin['nickname']; ?></span>
                </a>
                <ul class="dropdown-menu">
                    <!-- User image -->
                    <li class="user-header">
                        <img src="__YOUPAI__<?php echo $admin['avatar']; ?>" class="img-circle" alt="">
                    ...
                    <li class="user-footer">
                        <div class="pull-left">
                            <a href="general/profile" class="btn btn-default btn-flat addtabsit"><?php echo __('Profile'); ?></a>
                        </div>
...
<section class="sidebar">
    ...
    <div class="user-panel hidden-xs">
        <div class="pull-left image">
            <a href="general/profile" class="addtabsit"><img src="__YOUPAI__<?php echo $admin['avatar']; ?>" class="img-circle" /></a>
        </div>
...
<!-- /.sidebar -->
            ...
            <footer class="main-footer hide">
                ...
                <strong>Copyright &copy; 2017-2018 <a href="http://fastadmin.net">Aqua</a>.</strong> All rights
                reserved.
            </footer>
